# -*- coding: utf-8 -*-
"""Interim RestNet50.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VZs-aMlwO9OjM0iZblrqyaX1SxD-gM_B
"""
...
def setup_to_finetune(model):
  ...
  model.compile(optimizer=SGD(lr=0.0000000000001, momentum=0.9), loss='categorical_crossentropy', metrics=['accuracy'])
  #model.compile(Adam(lr=0.000000000000000001),loss='categorical', metrics=['accuracy'])
...
def train():
  ...
  # data prep
  train_datagen =  ImageDataGenerator(preprocessing_function=preprocess_input, rotation_range=5,width_shift_range=0.2,height_shift_range=0.2,shear_range=0.2,zoom_range=0.5,horizontal_flip=False, vertical_flip=True, rescale = 1/255 )
  ...
  predictions = model.predict_generator(validation_generator, steps=steps_per_epoch_val, verbose=1)
...
if __name__=="__main__":  
  ...
  plot_confusion_matrix(cm1, cm1_plot_labels, title='Confusion Matrix - Test')
