# -*- coding: utf-8 -*-
"""Interim InceptionV3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1URb15_7ubPq_t01Wh2CQAxctSbtUEwUD
"""
...
def setup_to_finetune(model):
  ...
  model.compile(optimizer=SGD(lr=0.0000001, momentum=0.9), loss='categorical_crossentropy', metrics=['accuracy'])
...
def train():
  ...
  predictions = model.predict_generator(test_generator, steps=steps_per_epoch_test, verbose=1)
