...
Original file is located at
    https://colab.research.google.com/drive/1JVH-WGuyM3JUJ2vjdUdep0PbHpIr6lks
"""
...
def train():
  ...
  # data prep
  train_datagen =  ImageDataGenerator(preprocessing_function=preprocess_input, rotation_range=5,width_shift_range=0.2,height_shift_range=0.2,shear_range=0.2,zoom_range=0.5,horizontal_flip=True, vertical_flip=True  )
  ...
  return history_tl, history_ft,test_labels,predictions
  
if __name__=="__main__":  
  history_tl, history_ft,test_labels,predictions = train()
